...
public class ClientThread extends Thread {
    ...
    static ArrayList<Friend> chatUserList = new ArrayList<Friend>();
    ...
    public void run() {
        ...
        try {
            ...
            ObjectExchange data;
            System.out.println(chatUserList.toString());
            Gson gson = new Gson();
            String client;
            while (!end_session && (data = (ObjectExchange) reader.readObject()) != null) {
                switch (data.messageCode) {
                    ...
                    case GIVE_FRIENDS_LIST:
                        ...
                        String json = gson.toJson(chatUserList);
                    ...
                    case FRIEND_CHANGE_NICK:
                        friend.nickName = gson.fromJson(data.message, String.class);
                        client = gson.toJson(friend);
                        for (int i = 0; i < arrayClientSocket.length; i++) {
                            if ((arrayClientSocket[i] != null) && (i != idThread)) {
                                ClientThread friendTread = arrayClientSocket[i];
                    ...
                    default:
                        ...
                        System.out.println("default Multicast message" + data.messageCode);
                }

                System.out.println("Received message " + idThread + ":" + data.message);
                System.out.println("Received code " + idThread + ":" + data.messageCode);
            ...
            try {
                synchronized (this) {
                    chatUserList.remove(this.friend);
